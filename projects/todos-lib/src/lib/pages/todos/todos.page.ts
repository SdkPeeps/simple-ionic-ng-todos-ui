      ...
      crudEvent:{
        before:{
          progress:{
            ...
            message: this.config.ui.pages.todosDetailEditor.behavior.urlInfo.progressMsg ||'Creating your todo',
          },
        },
      ...
      crudEvent:{
        before:{
          progress:{
            title: 'Please wait...',
            // spinner: this.config.spinner.type || 'bubbles',
            message: todosConfig.behavior.urlInfo.progressMsg ||'Updating your todo',
          },
        },
